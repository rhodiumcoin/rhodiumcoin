...
const string strMessageMagic = "RhodiumCoin Signed Message:\n";
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
	...
	if(pindexBest->nHeight < (8 * DAILY_BLOCKCOUNT))
        nRewardCoinYear = 1 * MAX_MINT_PROOF_OF_STAKE;
    else if(pindexBest->nHeight < (10 * DAILY_BLOCKCOUNT))
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in RhodiumCoin
    bool fStrictPayToScriptHash = true; // Always active in RhodiumCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "RhodiumCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
